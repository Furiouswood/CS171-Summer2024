...
public class Rectangle {
    ...
    public boolean contains(Rectangle rectangle) {
        return (rectangle.x >= this.x && rectangle.x + rectangle.L <= this.x + this.L && rectangle.y >= this.y
                && rectangle.y + rectangle.H <= this.y + this.H);
    }

    public boolean overlaps(Rectangle rectangle) {
        return (rectangle.x + rectangle.L >= this.x && rectangle.x <= this.x + this.L
                && rectangle.y + rectangle.H >= this.y && rectangle.y <= this.y + this.H);
    }
