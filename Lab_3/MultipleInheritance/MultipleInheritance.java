package Lab_3.MultipleInheritance;
...
// Redundant superinterface InterfaceA for the type ClassF, already defined by
// ClassD
...
public class MultipleInheritance {
        ...
        public static void main(String[] args) {
                ...
                // System.out.println("classA instanceof ClassD?" + (classA instanceof ClassD ?
                // " yes" : " no")); //compile error
                // System.out.println("classA instanceof ClassE?" + (classA instanceof ClassE ?
                // " yes" : " no")); //compile error
                // System.out.println("classA instanceof ClassF?" + (classA instanceof ClassF ?
                // " yes" : " no")); //compile error
                ...
                // System.out.println("classB instanceof ClassD?" + (classB instanceof ClassD ?
                // " yes" : " no")); //compile error
                // System.out.println("classB instanceof ClassE?" + (classB instanceof ClassE ?
                // " yes" : " no")); //compile error
                // System.out.println("classB instanceof ClassF?" + (classB instanceof ClassF ?
                // " yes" : " no")); //compile error
                ...
                // System.out.println("classC instanceof ClassD?" + (classC instanceof ClassD ?
                // " yes" : " no")); //compile error
                // System.out.println("classC instanceof ClassE?" + (classC instanceof ClassE ?
                // " yes" : " no")); //compile error
                // System.out.println("classC instanceof ClassF?" + (classC instanceof ClassF ?
                // " yes" : " no")); //compile error
                ...
                // System.out.println("classD instanceof ClassA?" + (classD instanceof ClassA ?
                // " yes" : " no")); //compile error
                // System.out.println("classD instanceof ClassB?" + (classD instanceof ClassB ?
                // " yes" : " no")); //compile error
                // System.out.println("classD instanceof ClassC?" + (classD instanceof ClassC ?
                // " yes" : " no")); //compile error
                ...
                // System.out.println("classE instanceof ClassA?" + (classE instanceof ClassA ?
                // " yes" : " no")); //compile error
                // System.out.println("classE instanceof ClassB?" + (classE instanceof ClassB ?
                // " yes" : " no")); //compile error
                // System.out.println("classE instanceof ClassC?" + (classE instanceof ClassC ?
                // " yes" : " no")); //compile error
                ...
                // System.out.println("classF instanceof ClassA?" + (classF instanceof ClassA ?
                // " yes" : " no")); //compile error
                // System.out.println("classF instanceof ClassB?" + (classF instanceof ClassB ?
                // " yes" : " no")); //compile error
                // System.out.println("classF instanceof ClassC?" + (classF instanceof ClassC ?
                // " yes" : " no")); //compile error
